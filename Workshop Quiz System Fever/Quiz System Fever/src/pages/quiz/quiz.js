import { submitSolution } from '../../api/solutions.js';
import { html, styleMap, classMap } from '../../library.js';
            ...
            <nav class="q-control">
                ...
                <div class="right-col">
                    ${currentIndex < questions.length - 1
                        ? html`<a class="action" href="/quiz/${quiz.objectId}?question=${currentIndex + 2}">
                            Next 
...
export async function quizPage(ctx) {
    ...
    async function onSubmit() {
        ...
        if (unanswered > 0) {
            const confirmed = confirm(`There are ${unanswered} unanswered questions! Are you sure you want to finish the quiz?`);
            if (!confirmed) {
                return;
            }
        }
        ...
        ctx.page.redirect('/results/' + ctx.quiz.objectId);
    }
